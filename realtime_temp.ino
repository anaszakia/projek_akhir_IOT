...
void loop() {
  ...
  if (!client.connected()) { 
    ...
    if (id == "") {
      reconnect("G_211_19_0115 G_211_19_0132"); 
    }
    else {
    ...
    Serial.println();
    if (topik_suhu == "") {
      SendMessages("iot/G_211_19_0115/G_211_19_0132", (String) s);
    }
    else {
      SendMessages(StringToChar(topik_suhu), (String) s);
    }
    if (topik_kelem == "") {
      SendMessages("iot/G_211_19_0115-1/G_211_19_0132-2", (String) k);
    }
    else {
